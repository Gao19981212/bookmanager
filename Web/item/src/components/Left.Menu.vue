...
<template>
  <div class="big">
    ...
    <div>
      <el-menu :default-active="active" class="left_menu" background-color="#46485f" active-text-color="#dea32c"
        text-color="#fff" :unique-opened="true" :collapse="isCollapse">
        <el-sub-menu index="1">
          <template #title>
            <el-icon>
              <avatar />
        ...
        <el-sub-menu index="3">
          ...
          <el-menu-item index="3-1">流通信息检索</el-menu-item>
          <el-menu-item index="3-2">图书赔偿</el-menu-item>
